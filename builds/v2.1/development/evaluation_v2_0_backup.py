"""
Static evaluation functions for chess positions - Cece v2.1

This module contains the core evaluation logic with tournament-tested improvements.
Focus on pure evaluation scoring with fixes for:
...
Based on analysis of actual tournament data showing problematic behaviors.
